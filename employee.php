  ...
  <div class="mian">
    ...
    <div class="page-login ba">
        ...
        <table class="tb">
          ...
          ?>
            ...
            <tr>
              ...
              <td class="tdt">
                <button class="btn-v"><a href="?id=<?php echo $cus[$n]['Emp_id']; ?>">view</a></button>
      ...
      <div class="col-2">
        ...
        ?>
        <p>id: <?php echo $sp[0]['Emp_id']; ?></p>
        <div class="f">
          <label class="l">User Name</label>
          <input type="text" name="" class="inp" value="<?php echo $sp[0]['Emp_UN']; ?>" />
        </div>
        <div class="f">
          <label class="l">Password</label>
          <input type="text" name="" class="inp" value="<?php echo $sp[0]['Emp_PW']; ?>" />
        </div>
        <div class="f">
          <label class="l">Prename</label>
          <input type="text" name="" class="inp" value="<?php echo $sp[0]['Emp_prename']; ?>"/>
        </div>
        <div class="f">
          <label class="l">Member name</label>
          <input type="text" name="" class="inp" value="<?php echo $sp[0]['Emp_firstname'] . " " . $sp[0]['Emp_lastname']; ?>" />
        </div>
        <div class="f">
          <label class="l">Position</label>
          <input type="text" name="" class="inp" value="<?php echo $sp[0]['Pos_name']; ?>"/>
        </div>
        <div class="f">
        ...
        <div class="f">
          ...
          <input type="text" name="" class="inp" value="<?php echo $sp[0]['Emp_bank']; ?>" />
        </div>
        <div class="f">
          <label class="l">Salary</label>
          <input type="text" name="" class="inp" value="<?php echo $sp[0]['Emp_salary']; ?>" />
        </div>
        <div class="bu">
